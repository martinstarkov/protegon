...
class HopperCollisionSystem : public ecs::System<TransformComponent, CollisionComponent, PlayerController> {
public:
	virtual void Update() override final {
		// Color reset.
		auto entities2 = GetManager().GetComponentTuple<TransformComponent, CollisionComponent>();
		...
		for (auto [entity, transform, collision_component, player] : entities) {
...
private:
	...
	void SortTimes(std::vector<Collision>& collisions) {
