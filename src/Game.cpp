...
void Game::init() {
	...
	manager.getEntity(box1).addComponents(DragComponent(0.1f), InputComponent(), PlayerController(Vec2D(1, 1)), StateMachineComponent(new WalkStateMachine(), new JumpStateMachine()));
