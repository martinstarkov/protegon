...
//// Each render target is initialized with a window camera. This can be changed by first setting
/// the / render target as current with game.renderer.SetRenderTarget(your_target) and then using /
