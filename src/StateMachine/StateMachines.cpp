...
WalkStateMachine::WalkStateMachine(StateName initialState, EntityHandle handle) : StateMachine(initialState) {
...
JumpStateMachine::JumpStateMachine(StateName initialState, EntityHandle handle) : StateMachine(initialState) {
