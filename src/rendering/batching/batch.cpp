...
// }
//
// bool Batch::Uses(const Shader& other_shader, const Camera& other_camera, BlendMode
// other_blend_mode) 	const { 	return shader == other_shader && blend_mode == other_blend_mode &&
//camera == other_camera;
// }
//
