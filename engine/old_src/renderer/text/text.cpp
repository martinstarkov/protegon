...
// }
//
// Text& Text::SetFont(const Handle<Font>& font) {
//	SetParameter(font);
//	return *this;
// }
//
...
// }
//
// Handle<Font> Text::GetFont() const {
//	return GetParameter(Handle<Font>{});
// }
//
...
//	Text t{ text };
//	return GetSize(
//		GetParameter(text, TextContent{}), GetParameter(text, Handle<Font>{}),
//		t.GetFontSize(t.IsHD(), camera)
//	);
// }
//
// V2_int Text::GetSize(
//	const TextContent& content, const Handle<Font>& font, const FontSize& font_size
//) {
//	return font.GetSize(content, font_size);
// }
//
...
//
// #ifndef __EMSCRIPTEN__ // TODO: Re-enable this for Emscripten once it is supported
// (SDL_ttf 2.24.0). 	if (properties.line_skip != std::numeric_limits<std::int32_t>::infinity()) {
...
//	const FontSize& font_size, const Handle<Font>& font, const TextProperties& properties
//) {
//	Text text{ manager.CreateEntity() };
//	text.Add<Handle<Texture>>();
//	SetDraw<Text>(text);
//	Show(text);
//	text.Add<impl::HDText>(true);
//	text.SetParameter(content, false);
//	text.SetParameter(text_color, false);
//	text.SetParameter(font, false);
