...
//	T, TextContent, TextColor, FontStyle, Handle<Font>, FontRenderMode, FontSize, TextLineSkip,
...
//	Text& SetFont(const Handle<Font>& font = {});
...
//
//	[[nodiscard]] Handle<Font> GetFont() const;
...
//		const Handle<Font>& font, const TextProperties& properties
//	);
//
//	template <typename T>
...
//	const FontSize& font_size = {}, const Handle<Font>& font = {},
