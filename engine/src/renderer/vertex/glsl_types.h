...
using float_ = std::array<std::float_t, 1>;
using vec2	 = std::array<std::float_t, 2>;
using vec3	 = std::array<std::float_t, 3>;
using vec4	 = std::array<std::float_t, 4>;

using double_ = std::array<std::double_t, 1>;
using dvec2	  = std::array<std::double_t, 2>;
using dvec3	  = std::array<std::double_t, 3>;
using dvec4	  = std::array<std::double_t, 4>;
