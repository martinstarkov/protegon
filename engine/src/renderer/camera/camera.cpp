...
// { 	if (disable_auto_resize) { 		auto_resize = false;
//	}
...
// }
//
// void Camera::SetViewport(const V2_float& new_viewport_position, const V2_float&
// new_viewport_size) { 	Get<impl::CameraInstance>().SetViewport(new_viewport_position,
//new_viewport_size);
// }
//
