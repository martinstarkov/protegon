...
constexpr TextureFormatDesc GetTextureFormatDesc(TextureFormat fmt) {
	switch (fmt) {
		...
		case TextureFormat::RGBA8:
			return { GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, false, false, false };
		case TextureFormat::RGBA8_SRGB:
			return { GL_SRGB8_ALPHA8, GL_RGBA, GL_UNSIGNED_BYTE, false, false, true };
		case TextureFormat::RGBA16F:
			return { GL_RGBA16F, GL_RGBA, GL_HALF_FLOAT, false, false, false };
		case TextureFormat::RGBA32F: return { GL_RGBA32F, GL_RGBA, GL_FLOAT, false, false, false };
		case TextureFormat::RG8:	 return { GL_RG8, GL_RG, GL_UNSIGNED_BYTE, false, false, false };
		case TextureFormat::R8:		 return { GL_R8, GL_RED, GL_UNSIGNED_BYTE, false, false, false };

		// -----------------------------------------------------------------
		// Color (16-bit / float)
		// -----------------------------------------------------------------
		case TextureFormat::R16F:	 return { GL_R16F, GL_RED, GL_HALF_FLOAT, false, false, false };
		case TextureFormat::RG16F:	 return { GL_RG16F, GL_RG, GL_HALF_FLOAT, false, false, false };

		// -----------------------------------------------------------------
		// Color (32-bit float)
		// -----------------------------------------------------------------
		case TextureFormat::R32F:	 return { GL_R32F, GL_RED, GL_FLOAT, false, false, false };
		case TextureFormat::RG32F:	 return { GL_RG32F, GL_RG, GL_FLOAT, false, false, false };
