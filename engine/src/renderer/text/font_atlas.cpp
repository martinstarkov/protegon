...
// }; constexpr std::array<char, 4> kFontDataChunkType{ 'p', 't', 'F', 'N' }; constexpr
// std::array<char, 4> kPngHeaderChunkType{ 'I', 'H', 'D', 'R' }; constexpr std::array<char, 4>
// kPngEndChunkType{ 'I', 'E', 'N', 'D' };
//
...
//		default:						  PTGN_ERROR("Unknown FileWriteError: ",
...
// { 	auto glyph{ GetGlyph(current_codepoint) }; 	if (!glyph.has_value()) { 		return 0.0f;
//	}
//
