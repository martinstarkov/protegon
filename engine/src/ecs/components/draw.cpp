...
//		}
//	}
//	if (entity.Has<Handle<Texture>>()) {
//		size = entity.Get<Handle<Texture>>().GetSize(entity);
//	}
//
...
//	if (!entity.Has<Handle<Texture>>() && !entity.Has<TextureCrop>()) {
//		return {};
//	}
...
// namespace impl {
//
// void DrawTexture(Renderer& renderer, const Entity& entity, bool flip_texture) {
...
//*/
//
// void DrawText(Renderer& renderer, const Entity& entity) {
//	// TODO: Fix.
//	// impl::DrawText(entity, V2_float{}, Camera{}, color::White, Origin::Center, V2_float{});
// }
//
// template <ShapeType T>
// static void DrawShape(Renderer& renderer, const Entity& entity) {
...
// }
//
// void DrawRect(Renderer& renderer, const Entity& entity) {
//	DrawShape<Rect>(renderer, entity);
// }
//
// void DrawRoundedRect(Renderer& renderer, const Entity& entity) {
//	DrawShape<RoundedRect>(renderer, entity);
// }
//
// void DrawArc(Renderer& renderer, const Entity& entity) {
//	DrawShape<Arc>(renderer, entity);
// }
//
// void DrawCapsule(Renderer& renderer, const Entity& entity) {
//	DrawShape<Capsule>(renderer, entity);
// }
//
// void DrawCircle(Renderer& renderer, const Entity& entity) {
//	DrawShape<Circle>(renderer, entity);
// }
//
// void DrawEllipse(Renderer& renderer, const Entity& entity) {
//	DrawShape<Ellipse>(renderer, entity);
// }
//
// void DrawLine(Renderer& renderer, const Entity& entity) {
//	DrawShape<Line>(renderer, entity);
// }
//
// void DrawPolygon(Renderer& renderer, const Entity& entity) {
//	DrawShape<Polygon>(renderer, entity);
// }
//
// void DrawTriangle(Renderer& renderer, const Entity& entity) {
//	DrawShape<Triangle>(renderer, entity);
// }
//
// void DrawShader(Renderer& renderer, const Entity& entity) {
//	// renderer.DrawShader(
