...
void TestTextures() {
	...
	// Texture t0_1{ "resources/totally_not_a_file......" };
	// Texture t0_2{ "resources/totally_not_a_file.png" };

	Texture t0{ "resources/test1.jpg" };

	PTGN_ASSERT(t0.IsValid());

	PTGN_ASSERT((t0.GetSize() == V2_int{ 320, 240 }));

	Texture t2{ "resources/test2.png" };
	// TODO: Figure out BMP issue on Mac OS.
	Texture t1; //{ "resources/test3.bmp" };
...
public:
	...
	constexpr static float rounded_rect_radius{ 30.0f };
	constexpr static float circle_radius{ 30.0f };
	constexpr static V2_float ellipse_radius{ 60.0f, 30.0f };
	constexpr static float capsule_radius{ 30.0f };
	constexpr static float arc_radius{ 30.0f };

	constexpr static float test_line_width{ 5.0f };

	constexpr static std::size_t batch_size{ 2000 };

	const path jpg_texture_path{ "resources/test1.jpg" };
	const path png_texture_path{ "resources/test2.png" };
	// const path bmp_texture_path{ "resources/test3.bmp" };
