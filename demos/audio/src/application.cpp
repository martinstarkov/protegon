...
Button CreateAudioButton(
	Scene& scene, const TextContent& content, const std::function<void()>& on_activate,
	const Color& bg_color = color::LightGray
) {
	Button b{ CreateTextButton(scene, content, color::Black) };
...
public:
	...
	void Enter() override {
		...
		b1 = grid.Set({ 0, 0 }, CreateAudioButton(*this, "Music Volume: ", []() {}, music_color));
		b2 = grid.Set(
			{ 0, 1 }, CreateAudioButton(
						  *this, "Music Is Playing: ", []() {}, music_color
					  )
		);
		b3 =
			grid.Set({ 0, 2 }, CreateAudioButton(*this, "Music Is Paused: ", []() {}, music_color));
		b4 =
			grid.Set({ 0, 3 }, CreateAudioButton(*this, "Music Is Fading: ", []() {}, music_color));
		b5 = grid.Set(
			{ 0, 4 }, CreateAudioButton(
						  *this, "Channel 1 Volume: ", []() {}, sound1_color
					  )
		);
		b7 = grid.Set(
			{ 0, 5 }, CreateAudioButton(
						  *this, "Channel 1 Playing: ", []() {}, sound1_color
					  )
		);
		b9 = grid.Set(
			{ 0, 6 }, CreateAudioButton(
						  *this, "Channel 1 Paused: ", []() {}, sound1_color
					  )
		);
		b11 = grid.Set(
			{ 0, 7 }, CreateAudioButton(
						  *this, "Channel 1 Fading: ", []() {}, sound1_color
					  )
		);
		b6 = grid.Set(
			{ 0, 8 }, CreateAudioButton(
						  *this, "Channel 2 Volume: ", []() {}, sound2_color
					  )
		);
		b8 = grid.Set(
			{ 0, 9 }, CreateAudioButton(
						  *this, "Channel 2 Playing: ", []() {}, sound2_color
					  )
		);
		b10 = grid.Set(
			{ 0, 10 }, CreateAudioButton(
						   *this, "Channel 2 Paused: ", []() {}, sound2_color
					   )
		);
		b12 = grid.Set(
			{ 0, 11 }, CreateAudioButton(
						   *this, "Channel 2 Fading: ", []() {}, sound2_color
					   )
		);

		grid.Set(
			{ 1, 0 }, CreateAudioButton(
						  *this, "Play Music 1", [&]() { game.music.Play("music1"); }, music_color
					  )
		);
		grid.Set(
			{ 1, 1 }, CreateAudioButton(
						  *this, "Play Music 2", [&]() { game.music.Play("music2"); }, music_color
					  )
		);
		grid.Set(
			{ 1, 2 }, CreateAudioButton(
						  *this, "Stop Music", [&]() { game.music.Stop(); }, music_color
					  )
		);
		grid.Set(
			{ 1, 3 }, CreateAudioButton(
						  *this, "Fade In Music 1 (3s)",
						  [&]() { game.music.FadeIn("music1", milliseconds{ 3000 }); }, music_color
					  )
		);
		grid.Set(
			{ 1, 4 }, CreateAudioButton(
						  *this, "Fade In Music 2 (3s)",
						  [&]() { game.music.FadeIn("music2", milliseconds{ 3000 }); }, music_color
					  )
		);
		grid.Set(
			{ 1, 5 }, CreateAudioButton(
						  *this, "Fade Out Music (3s)",
		...
		grid.Set(
			{ 1, 6 },
			CreateAudioButton(
				*this, "Toggle Music Pause", [&]() { game.music.TogglePause(); }, music_color
			)
		);
		grid.Set(
			{ 1, 7 }, CreateAudioButton(
						  *this, "Toggle Music Mute",
		...
		grid.Set(
			{ 2, 0 }, CreateAudioButton(
						  *this, "Play Channel 1", [&]() { game.sound.Play("sound1", channel1); },
						  sound1_color
					  )
		);
		grid.Set(
			{ 2, 1 },
			CreateAudioButton(
				*this, "Stop Channel 1", [&]() { game.sound.Stop(channel1); }, sound1_color
			)
		);
		grid.Set(
			{ 2, 2 },
			CreateAudioButton(
				*this, "Fade In Sound 1 (3s)",
		...
		grid.Set(
			{ 3, 0 }, CreateAudioButton(
						  *this, "Play Channel 2", [&]() { game.sound.Play("sound2", channel2); },
						  sound2_color
					  )
		);
		grid.Set(
			{ 3, 1 },
			CreateAudioButton(
				*this, "Stop Channel 2", [&]() { game.sound.Stop(channel2); }, sound2_color
			)
		);
		grid.Set(
			{ 3, 2 },
			CreateAudioButton(
				*this, "Fade In Sound 2 (3s)",
