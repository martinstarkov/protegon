...
std::unordered_map<std::string, Texture> FontManager::font_map_;

Texture FontManager::Load(std::string& text, const Color& color, const int size, const char* path) {
...
Texture FontManager::GetFont(const std::string& key) {
