...
if(AUTOMATIC_SDL)
  ...
  elseif(MINGW)
		download_and_extract(https://github.com/libsdl-org/SDL/releases/download/release-${SDL2_VERSION}/SDL2-devel-${SDL2_VERSION}-mingw.zip SDL2-${SDL2_VERSION} SDL2)
		download_and_extract(https://github.com/libsdl-org/SDL_image/releases/download/release-${SDL2_IMAGE_VERSION}/SDL2_image-devel-${SDL2_IMAGE_VERSION}-mingw.zip SDL2_image-${SDL2_IMAGE_VERSION} SDL2_image)
		download_and_extract(https://github.com/libsdl-org/SDL_ttf/releases/download/release-${SDL2_TTF_VERSION}/SDL2_ttf-devel-${SDL2_TTF_VERSION}-mingw.zip SDL2_ttf-${SDL2_TTF_VERSION} SDL2_ttf)
		download_and_extract(https://github.com/libsdl-org/SDL_mixer/releases/download/release-${SDL2_MIXER_VERSION}/SDL2_mixer-devel-${SDL2_MIXER_VERSION}-mingw.zip SDL2_mixer-${SDL2_MIXER_VERSION} SDL2_mixer)
		set(SDL2_DIR       ${EXTERNAL_DIR}/SDL2-${SDL2_VERSION}/cmake             CACHE BOOL "" FORCE)
		set(SDL2_image_DIR ${EXTERNAL_DIR}/SDL2_image-${SDL2_IMAGE_VERSION}/cmake CACHE BOOL "" FORCE)
		set(SDL2_ttf_DIR   ${EXTERNAL_DIR}/SDL2_ttf-${SDL2_TTF_VERSION}/cmake     CACHE BOOL "" FORCE)
		set(SDL2_mixer_DIR ${EXTERNAL_DIR}/SDL2_mixer-${SDL2_MIXER_VERSION}/cmake CACHE BOOL "" FORCE)
